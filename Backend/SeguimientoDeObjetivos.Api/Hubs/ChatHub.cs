...
namespace Api.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto dto)
        {
            ...
            // Los mensajes nuevos ya se ven con su propio contador en el ícono del chat
            // (chatService.unreadFrom); "Alertas" queda solo para tareas/objetivos, sin
            // mezclarse con mensajes.
        }
    }
}
